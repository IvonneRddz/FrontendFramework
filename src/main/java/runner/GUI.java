	 ...
	 JRadioButton[] radio ;
	  ...
	  public void init() {		  
		    ...
		    public void actionPerformed(java.awt.event.ActionEvent evt) {
		     ...
		     //New IE
		     JToggleButton option3 = new JToggleButton("IE Driver");
		     ...
		     //New Edge
		     JToggleButton option4 = new JToggleButton("Edge Driver");
		     ...
		     group.add(option1);
		     group.add(option2);
		     group.add(option3); //IE Driver
		     group.add(option4); // Edge Driver

		   JPanel p = new JPanel();
		// JPanel p2 = new JPanel(new BorderLayout(1,5));
		  JPanel p2 = new JPanel();
		    p.setSize(600, 400);
		    p.setLayout(new GridLayout(6,9));
		    
			   p.add(btnAll);
			   p.add(btnClear);
			   p.add(option1);
			   p.add(option2);
			   p.add(option3); //IE Driver
			   p.add(option4); //Edge Driver
