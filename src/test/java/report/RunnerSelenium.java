...
public class RunnerSelenium {
	...
	private void initWebDriver() {
		...
		if (choosedDriver == "firefox"){
			WebDriverManager.firefoxdriver().setup();
			driver = new FirefoxDriver();
		} else
		if (choosedDriver == "internetExplorer"){
			 WebDriverManager.iedriver().setup();
			driver = new InternetExplorerDriver();
		} else
		if (choosedDriver == "edge"){
	...
	public void testCase(List<StepSelenium> pasos) throws IOException {
		...
		if (choosedDriver == "internetExplorer"){
			test.fail("This page is not available for Internet Explorer");
			tearDown();
		};
